    ...
    <div class="offcanvas_menu">
        ...
        <div class="offcanvas_menu_wrapper">
                        ...
                        <div class="welcome_text">
                           <ul>
                               <li><span>Hotline:</span> 0796385112</li>
            ...
            <div class="container-fluid">
                <div class="middel_inner">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4">
                            <div class="logo">
                                <a href="index.html"><img src="assets/img/logo/HDTSHOP.png" width="150px" alt=""></a>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="cart_area">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="#">Danh mục <i class="fa fa-angle-down"></i></a>
                                            ...
                                            foreach($listCategory  as $a){
                                                extract($a);
                                            echo '<li><a href="index.php?act=shop_category&id='.$category_id.'"><b>'.$category_name.'</b></a></li>' ;
